...
model.ManageProgrammesAction = function (params) {
    var uid = 0;
    var privateStore = {};
    var me = this;
    ...
    me.getActionParameters = function () {
        return $.extend({}, getData(), {
            "CDSId": me.getCDSId(),
            "Programmes": me.getProgrammes(),
            "Markets": me.getMarkets()
        });
    };
    ...
    me.getMarkets = function () {
        return $("#" + me.getIdentifierPrefix() + "_FullName").val();
    };
    me.getProgrammes = function () {
        return $("#" + me.getIdentifierPrefix() + "_IsAdmin").val();
    };
    ...
    me.onSuccessEventHandler = function (sender, eventArgs) {
        $("#Modal_Notify")
            ...
            .html("New user '" + me.getCDSId() + "' added successfully")
            .show();
        $("#Modal_OK").hide();
