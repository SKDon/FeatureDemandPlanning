...
model.MarketReviewAction = function (params) {
    var uid = 0;
    var privateStore = {};
    var me = this;
    ...
    privateStore[me.id].ActionUri = params.MarketReviewUri;
    ...
    me.getActionParameters = function () {
        ...
        $.extend(actionParameters, { Comment: me.getComment(), MarketReviewStatus: me.getMarketReviewStatus() });
    ...
    me.onSuccessEventHandler = function (sender, eventArgs) {
        $("#Modal_Notify")
            ...
            .html("Take rate data submitted to market for review")
            .show();
        $("#Modal_OK").hide();
