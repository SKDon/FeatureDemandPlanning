...
var model = namespace("FeatureDemandPlanning.IgnoredException");

model.DeleteIgnoredExceptionAction = function (params) {
    var uid = 0;
    var privateStore = {};
    var me = this;
    ...
    privateStore[me.id].IgnoredExceptionId = params.IgnoredExceptionId;
    privateStore[me.id].IgnoredExceptionCode = params.IgnoredExceptionCode;
    ...
    me.getIgnoredExceptionId = function () {
        return $("#" + me.getIdentifierPrefix() + "_IgnoredExceptionId").val();
    };
    me.getIgnoredExceptionCode = function () {
        return privateStore[me.id].IgnoredExceptionCode;
    }
    ...
    me.onSuccessEventHandler = function (sender, eventArgs) {
        $("#Modal_Notify")
            ...
            .html("Ignored Exception deleted successfully")
            .show();
        $("#Modal_OK").hide();
