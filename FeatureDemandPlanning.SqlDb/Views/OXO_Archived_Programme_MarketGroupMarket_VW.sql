...
CREATE VIEW [dbo].[OXO_Archived_Programme_MarketGroupMarket_VW]
AS
    ...
    INNER JOIN dbo.OXO_Archived_Programme_MarketGroup  PMG
    ON P.ID = PMG.Programme_Id
    INNER JOIN dbo.OXO_Archived_Programme_MarketGroup_Market_Link  PMGM
