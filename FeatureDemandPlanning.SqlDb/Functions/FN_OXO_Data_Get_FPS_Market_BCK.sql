CREATE FUNCTION [dbo].[FN_OXO_Data_Get_FPS_Market_BCK] 
(
  @p_doc_id INT,
...
(
	...
	SELECT G.Feature_Id, G.Pack_Id, G.Model_Id, coalesce(MK.OXO_Code, M.OXO_Code + '**', G.OXO_Code + '*') AS OXO_Code
	FROM Generic G
	...
	ON G.Feature_Id = MK.Feature_Id
	AND G.Pack_Id = MK.Pack_Id
