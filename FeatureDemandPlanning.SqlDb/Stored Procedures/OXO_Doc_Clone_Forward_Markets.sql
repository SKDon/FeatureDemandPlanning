CREATE PROCEDURE [OXO_Doc_Clone_Forward_Markets] 
   @p_doc_id  int, 
   @p_prog_id  int, 
   @p_new_prog_id  int,    
...
BEGIN
	...
	BEGIN
		...
		SELECT Distinct @p_new_prog_id, Group_Name, Extra_Info, Active, Display_Order, Id,
		...
		SELECT Distinct @p_new_prog_id, P.Id, M.Country_Id, M.Sub_Region, @p_clone_by   
