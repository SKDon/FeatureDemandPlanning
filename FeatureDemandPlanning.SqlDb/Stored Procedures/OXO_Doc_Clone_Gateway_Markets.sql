CREATE PROCEDURE [dbo].[OXO_Doc_Clone_Gateway_Markets] 
   @p_doc_id  int, 
   @p_prog_id  int, 
   @p_new_doc_id  int,    
...
BEGIN
	...
	SELECT Distinct @p_new_doc_id, @p_prog_id, Market_Group_Name, NULL, 1, Display_Order, Market_Group_Id,
	...
	SELECT Distinct @p_new_doc_id, @p_prog_id, P.Id, M.Market_Id, M.SubRegion, @p_clone_by   
