CREATE PROCEDURE [dbo].[Fdp_ChangesetDataItem_CalculateVolumeForAllFeaturesForModel]
	@FdpChangesetDataItemId AS INT
AS
	SET NOCOUNT ON;

	DECLARE @TotalVolumeForModel AS INT
	...
	SELECT TOP 1 @TotalVolumeForModel = dbo.fn_Fdp_VolumeByModel_Get(D.FdpVolumeHeaderId, D.ModelId, D.FdpModelId, D.MarketId, D.CDSId)
	FROM 
	...
	LEFT JOIN Fdp_ChangesetDataItem_VW	AS CUR		ON	D1.FdpVolumeDataItemId		= CUR.FdpVolumeDataItemId
