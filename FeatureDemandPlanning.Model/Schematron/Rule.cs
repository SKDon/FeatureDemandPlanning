...
namespace FeatureDemandPlanning.Schematron
{
	...
	public class Rule : EvaluableExpression
	{
		...
		/// </param>
		public virtual Assert CreateAssert(string test, string source, string id, string area, string message)
		{
			return new Assert(test, source, id, area, message);
		}
		...
		/// <see cref="Test.Message"/>.
		/// </param>
        public virtual Report CreateReport(string test, string source, string id, string area, string message)
		{
			return new Report(test, source, id, area, message);
		}
		#endregion
		...
		/// <summary />
        public void AddAssert(string test, string source, string id, string area, string message)
		{
			_asserts.Add(CreateAssert(test, source, id, area, message));
		}

		/// <summary />
        public void AddReport(string test, string source, string id, string area, string message)
		{
			_reports.Add(CreateReport(test, source, id, area, message));
		}
