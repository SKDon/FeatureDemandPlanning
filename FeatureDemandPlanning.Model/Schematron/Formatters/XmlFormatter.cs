...
namespace FeatureDemandPlanning.Schematron.Formatters
{
	/// <summary>
	...
	public class XmlFormatter : FormatterBase
	{
		...
		{
            string id = source.Id;
            string area = source.Area;
            string src = source.Source;
            string type = (source.GetType() == typeof(Assert)) ? "Assert" : "Report";            
            ...
            // Write <text> element.  
            writer.WriteAttributeString("ruleid", id);
