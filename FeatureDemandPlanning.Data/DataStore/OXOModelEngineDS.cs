    ...
    public class ModelEngineDataStore: DataStoreBase
    {
        ...
        public IEnumerable<ModelEngine> ModelEngineGetMany(int progId)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
				...
				{
					AppHelper.LogError("ModelEngineDataStore.ModelEngineGetMany", ex.Message, CurrentCDSID);
				}
			}
        ...
        public ModelEngine ModelEngineGet(int id)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
			{
				...
				{
				   AppHelper.LogError("ModelEngineDataStore.ModelEngineGet", ex.Message, CurrentCDSID);
				}
			}
        ...
        public bool ModelEngineSave(ModelEngine obj)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
              ...
              //      para.Add("@p_Electrification", obj.Electrification, dbType: DbType.String, size: 50);
				...
				{
					AppHelper.LogError("ModelEngineDataStore.ModelEngineSave", ex.Message, CurrentCDSID);
					retVal = false;
				}
			}
        ...
        public bool ModelEngineDelete(int id)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
				...
				{
					AppHelper.LogError("ModelEngineDataStore.ModelEngineDelete", ex.Message, CurrentCDSID);
					retVal = false;
				}
			}
