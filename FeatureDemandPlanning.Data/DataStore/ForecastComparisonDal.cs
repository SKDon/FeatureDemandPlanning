    ...
    public class ForecastComparisonDataStore: DataStoreBase
    {
        ...
        public IEnumerable<ForecastComparison> ForecastComparisonGetMany()
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
				...
				{
					AppHelper.LogError("ForecastComparisonDataStore.ForecastComparisonGetMany", ex.Message, CurrentCDSID);
				}
			}
        ...
        public ForecastComparison ForecastComparisonGet(int id)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
			{
				...
				{
				   AppHelper.LogError("ForecastComparisonDataStore.ForecastComparisonGet", ex.Message, CurrentCDSID);
				}
			}
        ...
        public bool ForecastComparisonSave(ForecastComparison obj)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
				...
				{
					AppHelper.LogError("ForecastComparisonDataStore.ForecastComparisonSave", ex.Message, CurrentCDSID);
					retVal = false;
				}
			}
        ...
        public bool ForecastComparisonDelete(int id)
        {
			...
			using (IDbConnection conn = DbHelper.GetDBConnection())
            {
				...
				{
					AppHelper.LogError("ForecastComparisonDataStore.ForecastComparisonDelete", ex.Message, CurrentCDSID);
					retVal = false;
				}
			}
